...
class MelodyGenerator:
    ...
    def _sample_with_temperature(self, probabilities, temperature):
        ...
        """
        # +1e-8 is to avoid the "divide by zero" warning - Eddy
...
if __name__ == "__main__":
    mg = MelodyGenerator()
    seed1 = "67 _ 67 _ 67 _ _ 65 64 _ 64 _ 64 _ _ 62"
    seed = "55 _ 60 _ 55 _ 60 _ _ 59 60 _ 62 _ _ _"
    all = []
    for i in range(10):
        ...
        # seed = ' '.join(melody)
        if len(melody) % 16 != 0:
            melody = melody + ['_'] * (16 - len(melody) % 16)
        all = all + melody
    mg.save_melody(all, file_name='output.mid')
